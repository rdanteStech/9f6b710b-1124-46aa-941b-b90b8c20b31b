...
export const LIVE_ORDERS: LiveOrder[] = [
  {
    ...
    subtotal: 43000, tax: 9030, tip: 4300, total: 56330,
  ...
  },
  {
    ...
    subtotal: 13000, tax: 2730, tip: 0, total: 15730,
  ...
  },
  {
    ...
    subtotal: 17400, tax: 3654, tip: 0, total: 21554,
    paymentMethod: 'Mercado Pago', paymentStatus: 'paid',
    notes: 'Entregar en Av. Corrientes 1234, Depto 5B. Tocar timbre.',
    timeline: [
  ...
  },
  {
    ...
    subtotal: 51600, tax: 10836, tip: 5160, total: 67596,
  ...
  },
  {
    ...
    subtotal: 16500, tax: 3465, tip: 3300, total: 23265,
  ...
  },
  {
    ...
    subtotal: 15000, tax: 3150, tip: 0, total: 18150,
    paymentMethod: 'Efectivo', paymentStatus: 'pending',
