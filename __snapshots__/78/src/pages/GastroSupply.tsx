...
const SUPPLIERS: Supplier[] = [
  {
    id: 's1', name: 'Carnes Premium SpA', category: 'carnes', rating: 4.9, reviews: 128,
    location: 'Lo Espejo, Santiago', deliveryTime: '24-48 h', minOrder: 50000, status: 'active',
    products: 42, onTimeRate: 97, isPreferred: true, isVerified: true,
    contact: { phone: '+56 2 2456 7890', email: 'ventas@carnespremium.cl' },
  ...
  },
  {
    ...
    location: 'San Bernardo, RM', deliveryTime: '48-72 h', minOrder: 15000, status: 'active',
    products: 68, onTimeRate: 94, isVerified: true,
    contact: { phone: '+56 2 2420 1234', email: 'pedidos@molinosdelsur.cl' },
  ...
  },
  {
    ...
    location: 'Lo Valledor, Santiago', deliveryTime: 'Mismo día', minOrder: 8000, status: 'active',
    products: 120, onTimeRate: 99, isPreferred: true, isVerified: true,
    contact: { phone: '+56 2 2460 5678', email: 'info@verdurasfrescas.cl' },
  ...
  },
  {
    ...
    location: 'Osorno, Los Lagos', deliveryTime: '72 h', minOrder: 20000, status: 'active',
    products: 35, onTimeRate: 91, isVerified: true,
    contact: { phone: '+56 64 245 6789', email: 'ventas@lacteosartesanos.cl' },
  ...
  },
  {
    ...
    location: 'Santiago Centro', deliveryTime: '3-5 días', minOrder: 30000, status: 'active',
    products: 210, onTimeRate: 88,
    contact: { phone: '+56 2 2432 9876', email: 'compras@importadoragourmet.cl' },
    image: 'https://images.pexels.com/photos/5938/food-salad-healthy-lunch.jpg?w=400',
  },
  {
    id: 's6', name: 'Viña Casablanca', category: 'bebidas', rating: 4.9, reviews: 93,
    location: 'Valle de Casablanca', deliveryTime: '5-7 días', minOrder: 40000, status: 'active',
    products: 78, onTimeRate: 96, isPreferred: true, isVerified: true,
    contact: { phone: '+56 32 245 6789', email: 'mayorista@vinacasablanca.cl' },
  ...
  },
  {
    ...
    location: 'Quilicura, Santiago', deliveryTime: '48 h', minOrder: 12000, status: 'paused',
    products: 55, onTimeRate: 82,
    contact: { phone: '+56 2 2470 1111', email: 'ventas@distnorte.cl' },
...
const MARKETPLACE_PRODUCTS: MarketplaceProduct[] = [
  ...
  { id: 'p7', name: 'Carmenère Reserva 2022', supplier: 'Viña Casablanca', supplierId: 's6', category: 'bebidas', unit: 'bt', price: 8500, stock: 'available', image: 'https://images.pexels.com/photos/3407777/pexels-photo-3407777.jpeg?w=200', isBestPrice: true },
...
const SUPPLY_ORDERS: SupplyOrder[] = [
  ...
  { id: 'PO-0138', supplier: 'Viña Casablanca', items: 12, total: 102000, status: 'delivered', date: 'Hace 1 semana' },
]
...
const CONTRACTS: Contract[] = [
  ...
  { id: 'CT-003', supplier: 'Viña Casablanca', type: 'Exclusividad bebidas', startDate: '01 Jun 2024', endDate: '31 May 2025', value: 1224000, status: 'expiring', discount: 12 },
      ...
      {pendingInvoices.length > 0 && activeTab !== 'invoices' && (
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-xl"
          ...
          <div className="flex-1">
            ...
            <span className="text-sm text-gastro-subtle">
              El sistema identificó los productos. Revisa el resumen y aprueba el ingreso a stock con un clic.
            </span>
          </div>
      ...
      {expiringContracts > 0 && (
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-xl"
          ...
          <div className="flex-1">
            ...
            <span className="text-sm text-gastro-subtle">
              Viña Casablanca — exclusividad bebidas vence el 31 May 2025. Renueva para mantener el 12% de descuento.
            </span>
          </div>
                ...
                <div key={product.id} className="card-gastro group">
                  ...
                  {savings > 0 && (
                    <div className="flex items-center gap-1 text-xs text-success mb-3">
                      <TrendingDown size={11} /> Ahorras ${savings.toLocaleString()} vs. precio anterior
                    </div>
                  )}
          ...
          <div className="rounded-2xl p-6 w-full max-w-2xl shadow-2xl animate-slide-down max-h-[90dvh] overflow-y-auto"
            ...
            <div className="flex items-center justify-between mb-5">
              <div>
                ...
                <p className="text-xs text-gastro-subtle mt-0.5">{selectedInvoice.supplierName} · RUT {selectedInvoice.supplierCuit}</p>
              </div>
            ...
            {selectedInvoice.status === 'recognized' && (
              <div className="p-4 rounded-xl mb-5 flex items-start gap-3"
                ...
                <div>
                  ...
                  <div className="text-xs text-gastro-subtle mt-1">
                    El sistema vinculó los productos con tu inventario. Revisa el resumen y aprueba para actualizar GastroStock — no necesitas ingresar cantidades manualmente.
                  </div>
                </div>
              </div>
            )}
