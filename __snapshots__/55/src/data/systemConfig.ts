...
export const LOCATIONS: Location[] = [
  { id: 'loc-001', name: 'Osteria Moderna — Palermo', address: 'Av. Santa Fe 2847', city: 'CABA', status: 'active', tables: 24, staff: 18 },
  { id: 'loc-002', name: 'Osteria Moderna — Recoleta', address: 'Av. Callao 1234', city: 'CABA', status: 'active', tables: 18, staff: 14 },
  { id: 'loc-003', name: 'Osteria Moderna — Belgrano', address: 'Cabildo 2100', city: 'CABA', status: 'maintenance', tables: 16, staff: 12 },
]

export const DEFAULT_SYSTEM_CONFIG: SystemGlobalConfig = {
  brandName: 'Osteria Moderna',
