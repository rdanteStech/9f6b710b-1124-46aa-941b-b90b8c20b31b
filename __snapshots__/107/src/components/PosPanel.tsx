...
import { calcTax, formatCurrency, formatTime } from '../lib/locale'
          ...
          {mode === 'salon' ? (
            ...
            <div>
              ...
              <input
                ...
                placeholder={mode === 'takeaway' ? 'Ej. Diego Ramírez' : 'Ej. Valentina Cruz'}
        ...
        <div className="card-gastro p-4 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto space-y-2 mb-4 min-h-[200px]">
            {cart.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center py-8">
                ...
                <p className="text-sm text-gastro-subtle">Agrega productos desde la carta</p>
                <p className="text-xs text-gastro-muted mt-1">Selecciona mesa o tipo de pedido</p>
              </div>
            ) : (
              cart.map((line, index) => (
          ...
          <div className="space-y-2 pt-3 border-t" style={{ borderColor: '#1A2540' }}>
            ...
            {!canSubmit && cart.length > 0 && mode !== 'salon' && !customerName.trim() && (
              <p className="text-[10px] text-warning text-center">Ingresa el nombre del cliente</p>
            )}
          </div>
        </div>
      </div>
