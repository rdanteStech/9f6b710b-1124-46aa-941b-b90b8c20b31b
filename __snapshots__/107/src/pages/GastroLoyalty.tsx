...
const TIER_CONFIG = {
  Platinum: { color: '#2563EB', bg: 'rgba(37,99,235,0.12)', icon: Crown },
  Gold: { color: '#f59e0b', bg: 'rgba(245,158,11,0.12)', icon: Award },
  Silver: { color: '#8899BB', bg: 'rgba(136,136,170,0.12)', icon: Star },
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Miembros activos', value: '1.284', color: '#60A5FA', icon: Users },
          { label: 'Puntos emitidos', value: '284K', color: '#2563EB', icon: Star },
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="card-gastro">
            ...
            <div className="space-y-3">
              {[
                { tier: 'Platinum', members: 48, min: 10000, color: '#2563EB', perks: ['20% descuento', 'Mesa prioritaria', 'Sommelier personal'] },
                { tier: 'Gold', members: 186, min: 5000, color: '#f59e0b', perks: ['15% descuento', 'Reserva prioritaria', 'Postre de regalo'] },
                { tier: 'Silver', members: 412, min: 2000, color: '#8899BB', perks: ['10% descuento', 'Puntos dobles martes'] },
