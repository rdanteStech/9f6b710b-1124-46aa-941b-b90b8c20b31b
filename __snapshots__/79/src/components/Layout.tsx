...
import {
  ...
  Truck, Plug, GraduationCap, ChevronRight, Zap, X, ScanEye, CalendarCheck, ChefHat
} from 'lucide-react'
...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  Package, TrendingUp, Users, ClipboardList, BarChart3,
  Brain, Heart, Globe, Smartphone, Calendar, Network,
  Truck, Plug, GraduationCap, ScanEye, CalendarCheck, ChefHat,
}
  ...
  return (
    <div className="min-h-screen bg-gastro-bg flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Topbar — grid de 3 columnas para que la cuenta regresiva nunca se comprima */}
        <header
          className="h-14 grid grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-2 sm:gap-3 px-3 sm:px-6 flex-shrink-0 overflow-visible"
        ...
        >
          ...
          {/* Horario: cuenta regresiva + estado en vivo — columna fija, siempre visible */}
          <div className="flex items-center gap-1.5 sm:gap-2 w-max z-10">
            <ServeHoursCountdown
              compact
            ...
            <div
              className="flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded-lg whitespace-nowrap"
              style={
                isOpen
          ...
          {/* Notifications */}
          <div className="relative flex-shrink-0 justify-self-end">
