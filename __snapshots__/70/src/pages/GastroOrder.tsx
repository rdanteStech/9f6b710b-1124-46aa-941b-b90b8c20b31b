...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'm9', name: 'Vino Tinto Copa', description: 'Carmenère Reserva, Valle de Colchagua. Copa 150ml', price: 1200, category: 'Bebidas', image: 'https://images.pexels.com/photos/2912108/pexels-photo-2912108.jpeg?w=400', tags: [], destination: 'bar' },
  { id: 'm9b', name: 'Vino Tinto Botella', description: 'Carmenère Reserva, Valle de Colchagua. Botella 750ml — ideal para compartir', price: 4800, category: 'Bebidas', image: 'https://images.pexels.com/photos/2912108/pexels-photo-2912108.jpeg?w=400', tags: ['para compartir'], destination: 'bar', shareable: true },
