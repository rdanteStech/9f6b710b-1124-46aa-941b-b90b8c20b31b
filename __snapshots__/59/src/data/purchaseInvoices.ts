...
export const PURCHASE_INVOICES: PurchaseInvoice[] = [
  ...
  },
  {
    ...
    supplierId: 's6',
    supplierName: 'Bodega Mendoza',
    supplierCuit: '30-44556677-2',
    ...
    lines: [
      {
        id: 'l7',
        productName: 'Malbec Reserva 2022',
        quantity: 12,
        unit: 'bt',
        unitPrice: 8500,
        subtotal: 102000,
        inventoryItemId: 7,
        inventoryItemName: 'Vino Tinto Malbec',
        currentStock: 12,
        projectedStock: 24,
        matchStatus: 'matched',
        matchConfidence: 91,
