...
import {
  ...
  Truck, Plug, GraduationCap, ChevronRight, Zap, X
} from 'lucide-react'
      ...
      <aside className={`flex-shrink-0 flex flex-col transition-all duration-300 ${sidebarCollapsed ? 'w-16' : 'w-64'}`}
                        ...
                        <>
                          ...
                          {mod.badge && (
                            <span className="text-xs px-1.5 py-0.5 rounded font-bold"
                              style={{ background: 'rgba(0,102,255,0.2)', color: '#0066FF', fontSize: '9px' }}>
                              {mod.badge}
                            </span>
                          )}
                          {mod.isNew && (
        ...
        {!sidebarCollapsed && (
          <div className="px-3 py-2 border-t" style={{ borderColor: '#152035' }}>
            <div className="p-2.5 rounded-xl" style={{ background: 'rgba(0,102,255,0.08)', border: '1px solid rgba(0,102,255,0.15)' }}>
