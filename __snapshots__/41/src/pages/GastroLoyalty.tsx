...
const TIER_CONFIG = {
  Platinum: { color: '#0066FF', bg: 'rgba(0,102,255,0.12)', icon: Crown },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Miembros activos', value: '1.284', color: '#00B4FF', icon: Users },
          { label: 'Puntos emitidos', value: '284K', color: '#0066FF', icon: Star },
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="card-gastro">
            ...
            <div className="space-y-3">
              {[
                { tier: 'Platinum', members: 48, min: 10000, color: '#0066FF', perks: ['20% descuento', 'Mesa prioritaria', 'Sommelier personal'] },
