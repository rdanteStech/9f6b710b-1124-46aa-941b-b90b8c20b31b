  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, rgba(0,180,255,0.1) 0%, rgba(0,102,255,0.08) 100%)', border: '1px solid rgba(0,180,255,0.2)' }}>
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div className="ml-auto grid-cols-3 gap-6 text-center hidden md:grid">
            {[
              ...
              <div key={stat.label}>
                <div className="text-xl font-black" style={{ color: '#00B4FF' }}>{stat.value}</div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Conexiones', value: '284', color: '#00B4FF', icon: Users },
          { label: 'Perfil visto', value: '1.2K', color: '#0066FF', icon: Network },
          { label: 'Postulaciones', value: '12', color: '#3399FF', icon: Briefcase },
