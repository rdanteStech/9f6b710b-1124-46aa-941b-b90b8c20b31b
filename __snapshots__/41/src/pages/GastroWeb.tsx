  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Visitas este mes', value: '4.284', color: '#3399FF', icon: Globe },
          { label: 'Pedidos online', value: '312', color: '#0066FF', icon: ShoppingCart },
            ...
            <div className="space-y-2">
              {WEBSITE_SECTIONS.map(section => (
                <div key={section.id}
                  ...
                  style={activeSection === section.id ? { background: 'rgba(0,102,255,0.12)' } : {}}>
