...
const CHANNELS = [
  { id: 'salon', label: 'Salón', icon: UtensilsCrossed, color: '#0066FF' },
  { id: 'qr', label: 'QR Mesa', icon: Smartphone, color: '#3399FF' },
  ...
  { id: 'rappi', label: 'Rappi', icon: ShoppingBag, color: '#00B4FF' },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Productos activos', value: '84', color: '#0066FF', icon: BookOpen },
          { label: 'Categorías', value: '8', color: '#3399FF', icon: Layers },
          ...
          <div className="card-gastro h-fit">
            ...
            <div className="space-y-1">
              <button
                ...
                style={!activeCategory ? { background: 'rgba(0,102,255,0.12)' } : {}}>
                <span>Todos</span>
              ...
              {MENU_CATEGORIES.map(cat => (
                <button key={cat.id}
                  ...
                  style={activeCategory === cat.id ? { background: 'rgba(0,102,255,0.12)' } : {}}>
