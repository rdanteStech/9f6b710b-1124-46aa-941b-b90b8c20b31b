...
const CATEGORY_META: Record<SupplierCategory, { label: string; icon: typeof Beef; color: string }> = {
  ...
  lacteos: { label: 'Lácteos', icon: Package, color: '#3399FF' },
  verduras: { label: 'Verduras', icon: Leaf, color: '#10b981' },
  bebidas: { label: 'Bebidas', icon: Wine, color: '#0066FF' },
  secos: { label: 'Secos & Harinas', icon: Wheat, color: '#f59e0b' },
  gourmet: { label: 'Gourmet', icon: Box, color: '#00B4FF' },
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.12) 0%, rgba(51,153,255,0.06) 100%)', border: '1px solid rgba(16,185,129,0.25)' }}>
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex items-center gap-4 flex-1">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0"
              style={{ background: 'linear-gradient(135deg, #10b981, #3399FF)', boxShadow: '0 0 30px rgba(16,185,129,0.35)' }}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Pedidos activos', value: pendingOrders, color: '#3399FF', icon: ShoppingCart },
          { label: 'Contratos vigentes', value: CONTRACTS.filter(c => c.status === 'active').length, color: '#0066FF', icon: FileText },
