...
const FEATURES = [
  { icon: BookOpen, title: 'Carta Omnicanal', desc: 'Una sola fuente de verdad para todos tus canales de venta', color: '#0066FF' },
  { icon: UtensilsCrossed, title: 'GastroServe', desc: 'Pedidos, mesas, KDS y pagos integrados en tiempo real', color: '#3399FF' },
  { icon: Brain, title: 'IA Integrada', desc: 'Predicción de demanda, optimización de menú y alertas inteligentes', color: '#00B4FF' },
  ...
  { icon: Users, title: 'GastroTalent', desc: 'Gestión de turnos, RRHH y red profesional gastronómica', color: '#00B4FF' },
  { icon: Globe, title: 'GastroWeb', desc: 'Sitio web propio con pedidos online y delivery integrado', color: '#3399FF' },
  { icon: Heart, title: 'GastroLoyalty', desc: 'Programa de fidelización, CRM y marketing automatizado', color: '#0066FF' },
]

const MODULES_SHOWCASE = [
  { id: 'serve', name: 'GastroServe', icon: UtensilsCrossed, color: '#3399FF', desc: 'Pedidos & Mesas' },
  { id: 'menu', name: 'GastroMenu', icon: BookOpen, color: '#0066FF', desc: 'Carta Omnicanal' },
  ...
  { id: 'talent', name: 'GastroTalent', icon: Users, color: '#00B4FF', desc: 'Talento' },
  { id: 'insight', name: 'GastroInsight', icon: BarChart3, color: '#0066FF', desc: 'Analítica IA' },
  { id: 'loyalty', name: 'GastroLoyalty', icon: Heart, color: '#00B4FF', desc: 'Fidelización' },
  { id: 'web', name: 'GastroWeb', icon: Globe, color: '#3399FF', desc: 'Web Propia' },
  { id: 'network', name: 'GastroNetwork', icon: Network, color: '#00B4FF', desc: 'Red Pro' },
  { id: 'supply', name: 'GastroSupply', icon: Truck, color: '#10b981', desc: 'Proveedores' },
  { id: 'go', name: 'GastroGo', icon: Smartphone, color: '#0066FF', desc: 'App Cliente' },
  { id: 'predict', name: 'GastroPredict', icon: Brain, color: '#3399FF', desc: 'Predicción IA' },
]
    ...
    <div className="min-h-screen bg-gastro-bg text-gastro-text overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full opacity-20 animate-float-slow"
          style={{ background: 'radial-gradient(circle, rgba(0,102,255,0.4) 0%, transparent 70%)' }} />
        <div className="absolute top-[30%] right-[-15%] w-[500px] h-[500px] rounded-full opacity-15 animate-float"
          style={{ background: 'radial-gradient(circle, rgba(51,153,255,0.4) 0%, transparent 70%)' }} />
        <div className="absolute bottom-[10%] left-[20%] w-[400px] h-[400px] rounded-full opacity-10 animate-float-slow"
          style={{ background: 'radial-gradient(circle, rgba(0,180,255,0.4) 0%, transparent 70%)' }} />
      </div>
      ...
      <section className="landing-section">
        <div className="max-w-7xl mx-auto">
          <div className="rounded-3xl p-8 md:p-12 relative overflow-hidden"
            style={{ background: 'linear-gradient(135deg, rgba(0,102,255,0.08) 0%, rgba(51,153,255,0.05) 100%)', border: '1px solid rgba(0,102,255,0.2)' }}>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-3">
                {[
                  { channel: 'Salón & QR', icon: UtensilsCrossed, status: 'Activo', color: '#0066FF', items: '84 productos' },
                  { channel: 'Web Propia', icon: Globe, status: 'Activo', color: '#3399FF', items: '76 productos' },
                  ...
                  { channel: 'Take Away', icon: ShoppingBag, status: 'Activo', color: '#00B4FF', items: '84 productos' },
                ].map(ch => {
                  const Icon = ch.icon
                  return (
      ...
      <section className="landing-section">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: 'GastroAI', icon: Brain, color: '#0066FF', desc: 'Asistente conversacional para operaciones, menú y gestión diaria' },
              { name: 'GastroBrain', icon: Zap, color: '#3399FF', desc: 'Motor de optimización que analiza toda la operación en tiempo real' },
              { name: 'GastroPredict', icon: BarChart3, color: '#00B4FF', desc: 'Predicción de demanda, stock y comportamiento de clientes' },
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {PLANS.map(plan => (
              <div key={plan.name}
                ...
                style={{
                  background: plan.popular ? 'linear-gradient(135deg, rgba(0,102,255,0.12) 0%, rgba(51,153,255,0.06) 100%)' : '#0F1628',
                  border: `1px solid ${plan.popular ? 'rgba(0,102,255,0.4)' : '#1A2540'}`,
      ...
      <section className="landing-section">
        <div className="max-w-4xl mx-auto text-center">
          <div className="rounded-3xl p-12 relative overflow-hidden"
            style={{ background: 'linear-gradient(135deg, rgba(0,102,255,0.12) 0%, rgba(51,153,255,0.06) 50%, rgba(0,180,255,0.06) 100%)', border: '1px solid rgba(0,102,255,0.25)' }}>
            <div className="absolute inset-0 opacity-30"
              style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(0,102,255,0.3) 0%, transparent 60%)' }} />
