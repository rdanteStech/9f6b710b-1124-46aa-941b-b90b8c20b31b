...
const ALERT_CONFIG: Record<AlertType, { label: string; icon: LucideIcon; color: string; bg: string; emoji: string }> = {
            ...
            <div className="card-gastro">
              ...
              {selectedCamera ? (() => {
                ...
                <div className="text-center py-8 text-gastro-subtle text-xs">
                  Selecciona una cámara para ver el feed
                </div>
              )}
            </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-xs text-gastro-subtle mt-1">
                Configura detecciones, umbrales, asignación de mozos y canales de notificación
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="card-gastro">
              ...
              <p className="text-xs text-gastro-subtle mb-4">Activa o desactiva cada patrón que GastroEye analiza en las cámaras</p>
              <div className="space-y-2">
                {Object.entries(ALERT_CONFIG).map(([type, cfg]) => {
                  const Icon = cfg.icon
            ...
            <div className="card-gastro space-y-5">
              <div>
                ...
                <p className="text-xs text-gastro-subtle mb-4">Ajusta la sensibilidad del modelo de visión por computadora</p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="card-gastro lg:col-span-2">
              ...
              <p className="text-xs text-gastro-subtle mb-4">Asocia cada cámara con las mesas que monitorea</p>
              <div className="space-y-2">
                {CAMERAS.map(cam => (
