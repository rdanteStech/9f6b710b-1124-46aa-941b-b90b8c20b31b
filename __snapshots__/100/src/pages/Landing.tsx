...
const FEATURES = [
  ...
  { icon: Contact, title: 'GastroClients', desc: 'CRM con historial, consumo, preferencias y segmentación de clientes', color: '#60A5FA', image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&q=80' },
]
...
const MODULES_SHOWCASE = [
  ...
  { id: 'clients', name: 'GastroClients', icon: Contact, color: '#60A5FA', desc: 'CRM Clientes', image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=80' },
