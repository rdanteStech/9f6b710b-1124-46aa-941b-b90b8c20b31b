...
import {
  ChefHat, Zap, Globe, BarChart3, Users, Package, TrendingUp,
...
const FEATURES = [
  { icon: BookOpen, title: 'Carta Omnicanal', desc: 'Una sola fuente de verdad para todos tus canales de venta', color: '#9E7FFF' },
  { icon: UtensilsCrossed, title: 'GastroServe', desc: 'Pedidos, mesas, KDS y pagos integrados en tiempo real', color: '#38bdf8' },
  { icon: Brain, title: 'IA Integrada', desc: 'Predicción de demanda, optimización de menú y alertas inteligentes', color: '#f472b6' },
  ...
  { icon: Users, title: 'GastroTalent', desc: 'Gestión de turnos, RRHH y red profesional gastronómica', color: '#f472b6' },
  { icon: Globe, title: 'GastroWeb', desc: 'Sitio web propio con pedidos online y delivery integrado', color: '#38bdf8' },
  { icon: Heart, title: 'GastroLoyalty', desc: 'Programa de fidelización, CRM y marketing automatizado', color: '#9E7FFF' },
]

const MODULES_SHOWCASE = [
  { id: 'serve', name: 'GastroServe', icon: UtensilsCrossed, color: '#38bdf8', desc: 'Pedidos & Mesas' },
  { id: 'menu', name: 'GastroMenu', icon: BookOpen, color: '#9E7FFF', desc: 'Carta Omnicanal' },
  ...
  { id: 'talent', name: 'GastroTalent', icon: Users, color: '#f472b6', desc: 'Talento' },
  { id: 'insight', name: 'GastroInsight', icon: BarChart3, color: '#9E7FFF', desc: 'Analítica IA' },
  { id: 'loyalty', name: 'GastroLoyalty', icon: Heart, color: '#f472b6', desc: 'Fidelización' },
  { id: 'web', name: 'GastroWeb', icon: Globe, color: '#38bdf8', desc: 'Web Propia' },
  { id: 'network', name: 'GastroNetwork', icon: Network, color: '#f472b6', desc: 'Red Pro' },
  { id: 'supply', name: 'GastroSupply', icon: Truck, color: '#10b981', desc: 'Proveedores' },
  { id: 'go', name: 'GastroGo', icon: Smartphone, color: '#9E7FFF', desc: 'App Cliente' },
  { id: 'predict', name: 'GastroPredict', icon: Brain, color: '#38bdf8', desc: 'Predicción IA' },
]
    ...
    <div className="min-h-screen bg-gastro-bg text-gastro-text overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full opacity-20 animate-float-slow"
          style={{ background: 'radial-gradient(circle, rgba(158,127,255,0.4) 0%, transparent 70%)' }} />
      ...
      <section className="landing-section">
        <div className="max-w-7xl mx-auto">
          <div className="rounded-3xl p-8 md:p-12 relative overflow-hidden"
            style={{ background: 'linear-gradient(135deg, rgba(158,127,255,0.08) 0%, rgba(56,189,248,0.05) 100%)', border: '1px solid rgba(158,127,255,0.2)' }}>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-3">
                {[
                  { channel: 'Salón & QR', icon: UtensilsCrossed, status: 'Activo', color: '#9E7FFF', items: '84 productos' },
                  { channel: 'Web Propia', icon: Globe, status: 'Activo', color: '#38bdf8', items: '76 productos' },
                  ...
                  { channel: 'Take Away', icon: ShoppingBag, status: 'Activo', color: '#f472b6', items: '84 productos' },
                ].map(ch => {
                  const Icon = ch.icon
                  return (
      ...
      <section className="landing-section">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: 'GastroAI', icon: Brain, color: '#9E7FFF', desc: 'Asistente conversacional para operaciones, menú y gestión diaria' },
              { name: 'GastroBrain', icon: Zap, color: '#38bdf8', desc: 'Motor de optimización que analiza toda la operación en tiempo real' },
              { name: 'GastroPredict', icon: BarChart3, color: '#f472b6', desc: 'Predicción de demanda, stock y comportamiento de clientes' },
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {PLANS.map(plan => (
              <div key={plan.name}
                ...
                style={{
                  background: plan.popular ? 'linear-gradient(135deg, rgba(158,127,255,0.12) 0%, rgba(56,189,248,0.06) 100%)' : '#1a1a26',
                  border: `1px solid ${plan.popular ? 'rgba(158,127,255,0.4)' : '#2a2a3d'}`,
                  boxShadow: plan.popular ? '0 0 40px rgba(158,127,255,0.15)' : 'none',
                }}>
                {plan.popular && (
      ...
      <section className="landing-section">
        <div className="max-w-4xl mx-auto text-center">
          <div className="rounded-3xl p-12 relative overflow-hidden"
            style={{ background: 'linear-gradient(135deg, rgba(158,127,255,0.12) 0%, rgba(56,189,248,0.06) 50%, rgba(244,114,182,0.06) 100%)', border: '1px solid rgba(158,127,255,0.25)' }}>
            <div className="absolute inset-0 opacity-30"
              style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(158,127,255,0.3) 0%, transparent 60%)' }} />
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6"
                style={{ background: 'linear-gradient(135deg, #9E7FFF, #7c3aed)', boxShadow: '0 0 40px rgba(158,127,255,0.4)' }}>
