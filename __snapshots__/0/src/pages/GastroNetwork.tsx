...
import { Network, Users, Star, Briefcase, MapPin, Award, Search, Filter, Plus, Heart, MessageCircle, Share2 } from 'lucide-react'
...
const PROFESSIONALS = [
  {
    ...
    image: 'https://images.<boltArtifact id="gastro360-platform-continued" title="Gastro360 - Continued">
<boltAction type="file" filePath="src/pages/GastroNetwork.tsx">
import { useState } from 'react'
import { Network, Users, Star, Briefcase, MapPin, Award, Search, Filter, Plus, Heart, MessageCircle, Share2, CheckCircle } from 'lucide-react'
...
const FEED_POSTS = [
  {
    ...
    content: 'Nuevo plato en carta: Risotto nero con calamares y espuma de parmesano. Tres semanas de desarrollo para lograr el balance perfecto entre el tintero y la cremosidad. ¿Qué opinan?',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, rgba(244,114,182,0.1) 0%, rgba(158,127,255,0.08) 100%)', border: '1px solid rgba(244,114,182,0.2)' }}>
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div className="ml-auto grid grid-cols-3 gap-6 text-center hidden md:grid">
            {[
              ...
              <div key={stat.label}>
                <div className="text-xl font-black text-accent-400">{stat.value}</div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Conexiones', value: '284', color: '#f472b6', icon: Users },
          { label: 'Perfil visto', value: '1.2K', color: '#9E7FFF', icon: Network },
          { label: 'Postulaciones', value: '12', color: '#38bdf8', icon: Briefcase },
            ...
            {filteredPros.map(pro => (
              <div key={pro.id} className="card-gastro group cursor-pointer">
                ...
                <button className="w-full mt-3 py-2 rounded-xl text-xs font-semibold transition-all text-primary-400 hover:text-white"
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.background = 'rgba(158,127,255,0.25)'
                  }}
                  onMouseLeave={e => {
        ...
        <div className="max-w-2xl space-y-4">
          ...
          {FEED_POSTS.map(post => (
            <div key={post.id} className="card-gastro">
              ...
              <div className="flex items-center gap-4 pt-3 border-t" style={{ borderColor: '#2a2a3d' }}>
