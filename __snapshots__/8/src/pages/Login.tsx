...
import { ChefHat, Mail, Lock, ArrowRight, Eye, EyeOff, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gastro-bg flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full opacity-20 animate-float-slow"
          style={{ background: 'radial-gradient(circle, rgba(158,127,255,0.5) 0%, transparent 70%)' }} />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-gastro-text">
            <span className="gradient-text-primary">Gastro</span>360
          </h1>
          <p className="text-sm text-gastro-subtle mt-1">El sistema operativo de tu restaurante</p>
        </div>

        {/* Card */}
        <div className="rounded-2xl p-8" style={{ background: '#1a1a26', border: '1px solid #2a2a3d' }}>
