import pixelesimport { useState, useRef, useCallback } from 'react'
...
function TableSVG({ table, selected, onSelect, onDragStart, minDist, onUnfuse, wallDistPx }: {
  ...
  return (
    ...
    >
      ...
      <text x={cx} y={cy - 5} textAnchor="middle" domin<boltArtifact id="gastro-layout-text-wall-fixes" title="GastroLayout — Fix text rotation + wall magnet">
<boltAction type="update" filePath="src/pages/GastroLayout.tsx">
              ...
              <>
                ...
                {drawingPoints.map((p, i) => (
                  <circle key={i} cx={p.x} cy={p.y} r={4}
                    fill={activeZone.color} stroke="#0d0d18" strokeWidth={1.5} />
                ))}
              </>
            )}
