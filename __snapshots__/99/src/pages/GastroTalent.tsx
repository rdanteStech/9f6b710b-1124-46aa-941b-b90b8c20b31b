...
const INITIAL_ORG: OrgNode = {
  ...
  department: 'Dirección', avatar: 'MR', color: '#2563EB', status: 'active',
  reports: [
    {
      id: '2', name: 'Sofía Herrera', role: 'Gerente General',
      department: 'Gerencia', avatar: 'SH', color: '#3B82F6', status: 'active',
      reports: [
        {
        ...
        },
        {
          ...
          department: 'Salón', avatar: 'VC', color: '#60A5FA', status: 'active',
          reports: [
            { id: '7', name: 'María González', role: 'Moza Senior', department: 'Salón', avatar: 'MG', color: '#60A5FA', status: 'active' },
            { id: '8', name: 'Roberto Sosa', role: 'Mozo', department: 'Salón', avatar: 'RS', color: '#60A5FA', status: 'vacation' },
            { id: '9', name: 'Camila Torres', role: 'Moza', department: 'Salón', avatar: 'CT', color: '#60A5FA', status: 'active' },
          ]
        },
        {
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gastro-subtle">Modifica los datos del nodo</p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              className="w-full px-4 py-2.5 rounded-xl text-sm text-gastro-text outline-none focus:ring-2 focus:ring-primary-500"
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #2563EB, #7c5ce0)' }}
          >
...
function AddPositionModal({
  ...
  const handleSubmit = () => {
    ...
    const color = DEPT_COLORS[form.department] ?? '#2563EB'
      ...
      >
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button
            ...
            style={{
              background: isValid ? 'linear-gradient(135deg, #2563EB, #7c5ce0)' : 'rgba(37,99,235,0.2)',
      ...
      <div className="relative group">
        <div
          ...
          style={{
            ...
            border: `1px solid ${isRoot ? 'rgba(37,99,235,0.4)' : '#1A2540'}`,
            minWidth: isRoot ? '200px' : '160px',
            boxShadow: isRoot ? '0 0 24px rgba(37,99,235,0.15)' : 'none',
          }}
...
function DeptLegend({ orgData }: { orgData: OrgNode }) {
  const allNodes = flattenNodes(orgData)
  const depts = [
    { name: 'Dirección', color: '#2563EB', icon: Crown },
    { name: 'Gerencia', color: '#3B82F6', icon: Building2 },
    { name: 'Cocina', color: '#f59e0b', icon: ChefHat },
    { name: 'Salón', color: '#60A5FA', icon: UtensilsCrossed },
...
export default function GastroTalent() {
  ...
  const deptStats = [
    { dept: 'Dirección', color: '#2563EB', icon: Crown },
    { dept: 'Gerencia', color: '#3B82F6', icon: Building2 },
    { dept: 'Cocina', color: '#f59e0b', icon: ChefHat },
    { dept: 'Salón', color: '#60A5FA', icon: UtensilsCrossed },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Horas esta semana', value: '284', color: '#2563EB', icon: Clock },
          { label: 'Satisfacción promedio', value: '4.7', color: '#f59e0b', icon: Star },
          { label: 'Vacantes abiertas', value: JOB_LISTINGS.length, color: '#3B82F6', icon: Briefcase },
        ].map(stat => {
      ...
      {activeView === 'recruitment' && (
        <div className="space-y-4">
          ...
          <div className="rounded-2xl p-6 relative overflow-hidden"
            style={{ background: 'linear-gradient(135deg, rgba(96,165,250,0.08) 0%, rgba(37,99,235,0.06) 100%)', border: '1px solid rgba(96,165,250,0.2)' }}>
