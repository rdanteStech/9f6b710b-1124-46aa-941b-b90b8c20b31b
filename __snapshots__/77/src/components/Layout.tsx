  ...
  return (
    <div className="min-h-screen bg-gastro-bg flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Topbar */}
        <header
          className="h-14 flex items-center gap-2 sm:gap-3 px-3 sm:px-6 flex-shrink-0 min-w-0"
        ...
        >
          ...
          {/* Horario: cuenta regresiva + estado en vivo — siempre visible a la izquierda de "En vivo" */}
