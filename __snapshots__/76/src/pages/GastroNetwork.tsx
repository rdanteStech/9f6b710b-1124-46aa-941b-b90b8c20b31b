...
const PROFESSIONALS = [
  {
    id: 1, name: 'Chef Martín Acosta', role: 'Executive Chef', location: 'Santiago', rating: 4.9,
  ...
  {
    id: 2, name: 'Ana Rodríguez', role: 'Sommelier & Wine Director', location: 'Valle de Colchagua', rating: 4.8,
    experience: '8 años', specialties: ['Vinos chilenos', 'Maridaje', 'Catas'],
  ...
  {
    id: 3, name: 'Roberto Silva', role: 'Bartender & Mixólogo', location: 'Valparaíso', rating: 4.7,
  ...
  {
    id: 4, name: 'Valentina Cruz', role: 'Sous Chef & Pastelera', location: 'Providencia', rating: 4.9,
  ...
  {
    id: 5, name: 'Diego Ramírez', role: 'Restaurant Manager', location: 'Viña del Mar', rating: 4.6,
  ...
  {
    id: 6, name: 'Camila Torres', role: 'Chef de Partie', location: 'Las Condes', rating: 4.5,
...
const FEED_POSTS = [
  ...
  },
  {
    ...
    content: 'Explorando el Negroni con vermut artesanal del Valle de Casablanca. El resultado es increíble: más herbáceo, menos dulce, con notas de lavanda. La coctelería chilena tiene mucho por dar.',
  ...
  return (
    <div className="space-y-6">
      ...
      {activeView === 'jobs' && (
        <div className="space-y-4">
          {[
            { id: 1, title: 'Executive Chef', company: 'Grupo Gastronómico Ríos', location: 'Santiago', type: 'Full-time', salary: '$2.800.000 - $3.800.000', posted: 'Hace 1 día', applicants: 18, urgent: true },
            { id: 2, title: 'Sommelier', company: 'Hotel W Santiago', location: 'Las Condes', type: 'Full-time', salary: '$1.800.000 - $2.400.000', posted: 'Hace 3 días', applicants: 9, urgent: false },
            { id: 3, title: 'Bartender Senior', company: 'The Ritz Bar', location: 'Bellavista', type: 'Full-time', salary: '$1.500.000 - $2.000.000', posted: 'Hace 5 días', applicants: 24, urgent: false },
            { id: 4, title: 'Sous Chef Pastelería', company: 'Ambrosia', location: 'Santiago', type: 'Full-time', salary: '$1.600.000 - $2.200.000', posted: 'Hace 1 semana', applicants: 14, urgent: false },
            { id: 5, title: 'Restaurant Manager', company: 'Boragó', location: 'Santiago', type: 'Full-time', salary: '$2.000.000 - $2.800.000', posted: 'Hace 2 semanas', applicants: 31, urgent: false },
          ].map(job => (
