      ...
      <div className="grid md:grid-cols-3 gap-6">
        {PLANS.map(plan => (
          <div key={plan.name}
            ...
            style={{
              background: plan.current ? 'linear-gradient(135deg, rgba(158,127,255,0.12) 0%, rgba(56,189,248,0.06) 100%)' : '#1a1a26',
              border: `1px solid ${plan.current ? 'rgba(158,127,255,0.4)' : '#2a2a3d'}`,
              boxShadow: plan.current ? '0 0 40px rgba(158,127,255,0.15)' : 'none',
            }}>
            {plan.current && (
            ...
            <button
              ...
              style={plan.current ? { background: 'rgba(255,255,255,0.05)', border: '1px solid #2a2a3d' } : {}}>
