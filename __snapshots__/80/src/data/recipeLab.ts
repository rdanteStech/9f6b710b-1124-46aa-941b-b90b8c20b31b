...
export const RECIPE_LAB_ENTRIES: RecipeLabEntry[] = [
    ...
    versions: [
      {
        ...
        ingredients: [
          ...
          { inventoryItemId: 7, name: 'Vino Tinto Carmenère', quantity: 0.08, unit: 'bt' },
        ],
        steps: [
          ...
          'Deglasar con vino Carmenère hasta evaporar.',
  ...
  },
  {
    ...
    objective: 'Postre premium para carta de vinos — pareo con Carmenère',
    versions: [
      {
        id: 'v1',
        version: '0.9',
