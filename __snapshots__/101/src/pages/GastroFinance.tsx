    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Utilidad neta', value: `$${(profit / 1000).toFixed(0)}K`, change: '+18.7%', positive: true, color: '#2563EB', icon: DollarSign },
          { label: 'Margen neto', value: `${margin}%`, change: '+2.1pp', positive: true, color: '#3B82F6', icon: PieChart },
        ].map(kpi => {
          const Icon = kpi.icon
          return (
        ...
        <div className="card-gastro">
          ...
          <div className="space-y-3">
            {FINANCE_DATA.expenses.map((exp, i) => {
              const colors = ['#2563EB', '#3B82F6', '#60A5FA', '#f59e0b', '#10b981', '#8899BB']
              return (
