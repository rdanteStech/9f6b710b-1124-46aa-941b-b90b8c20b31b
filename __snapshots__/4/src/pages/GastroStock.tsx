  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Insumos totales', value: INVENTORY_ITEMS.length, color: '#9E7FFF', icon: Package },
          ...
          { label: 'Órdenes pendientes', value: 2, color: '#38bdf8', icon: ShoppingCart },
        ].map(stat => {
                    ...
                    <td className="w-32">
                      <div className="progress-bar">
                        <div className="progress-fill" style={{
                          width: `${pct}%`,
                          background: item.status === 'critical' ? '#ef4444' : item.status === 'low' ? '#f59e0b' : 'linear-gradient(90deg, #9E7FFF, #38bdf8)'
                        }} />
                      </div>
                ...
                <div className="ml-6">
                  <div className="w-16 h-16 relative">
                    <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
                      <circle cx="18" cy="18" r="15.9" fill="none" stroke="#2a2a3d" strokeWidth="3" />
