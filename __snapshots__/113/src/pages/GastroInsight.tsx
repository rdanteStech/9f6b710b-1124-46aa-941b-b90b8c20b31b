...
const PRIORITY_CONFIG = {
  ...
  medium: { color: '#3B82F6', bg: 'rgba(59,130,246,0.1)', label: 'Media' },
        ...
        <div className="lg:col-span-2 card-gastro">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={[...REVENUE_DATA, { day: 'Lun+', revenue: 720000, orders: 280, target: 650000 }, { day: 'Mar+', revenue: 680000, orders: 265, target: 620000 }]}
              ...
              <Area type="monotone" dataKey="revenue" stroke="#2563EB" strokeWidth={2.5} fill="url(#revGrad2)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      ...
      <div className="card-gastro">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: '🐄 Vacas', desc: 'Alta rotación + margen medio', products: ['Pizza Margherita', 'Lomo a la Pimienta'], color: '#3B82F6' },
