...
export default function GastroOps() {
  ...
  const tempAlerts = TEMPERATURE_LOGS.filter(t => t.status !== 'ok').length
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 relative overflow-hidden"
        style={{
          background: 'linear-gradient(135deg, rgba(245,158,11,0.08) 0%, rgba(37,99,235,0.06) 50%, rgba(16,185,129,0.04) 100%)',
          ...
          <div className="space-y-4">
            ...
            <div className="card-gastro p-5">
              ...
              <div className="space-y-2">
                {[
                  { label: 'Registrar temperatura', icon: Thermometer, color: '#2563EB', action: () => setActiveTab('temperatures') },
                  { label: 'Reportar incidencia', icon: AlertTriangle, color: '#ef4444', action: () => setActiveTab('incidents') },
            ...
            <div className="card-gastro p-5">
              ...
              <div className="p-3 rounded-xl text-sm" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid #1A2540' }}>
                ...
                <p className="text-gastro-text text-sm leading-relaxed">
                  Stock de vinos Malbec bajo (6 botellas). Evento privado mañana 13hs — 45 pax, menú ejecutivo confirmado. Congelador pescados requiere revisión técnica.
                </p>
              </div>
                ...
                <div key={tpl.id} className="card-gastro p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => showToast(`Checklist "${tpl.name}" iniciado`)}
      ...
      {activeTab === 'temperatures' && (
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-gastro-subtle">Registro HACCP del día — {TEMPERATURE_LOGS.length} lecturas</p>
            <button className="btn-primary text-sm px-4 py-2"><Plus size={15} /> Nueva lectura</button>
          </div>
      ...
      {activeTab === 'incidents' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button className="btn-primary text-sm px-4 py-2"><Plus size={15} /> Reportar incidencia</button>
          </div>
          <div className="space-y-3">
            {INCIDENTS.map(inc => {
