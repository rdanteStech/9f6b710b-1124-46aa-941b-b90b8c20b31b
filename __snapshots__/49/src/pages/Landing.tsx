...
function AnimatedCounter({
  ...
  return (
    <span ref={ref}>
      {decimals > 0 ? count.toFixed(decimals) : Math.floor(count).toLocaleString('es')}
      {suffix}
    </span>
  )
}
  ...
  return (
    <div
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        {[
          { label: 'Ventas', val: '$48.2K', change: '+12%', color: '#2563EB' },
          { label: 'Mesas', val: '34/42', change: '81%', color: '#3B82F6' },
          { label: 'Ticket', val: '$28.4K', change: '+8%', color: '#10b981' },
