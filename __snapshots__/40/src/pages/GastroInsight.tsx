...
const PRIORITY_CONFIG = {
  ...
  medium: { color: '#38bdf8', bg: 'rgba(56,189,248,0.1)', label: 'Media' },
  low: { color: '#8888aa', bg: 'rgba(136,136,170,0.1)', label: 'Baja' },
}
      ...
      <div className="rounded-2xl p-6 relative overflow-hidden"
        ...
        <div className="relative z-10 flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0"
            style={{ background: 'linear-gradient(135deg, #9E7FFF, #7c3aed)', boxShadow: '0 0 30px rgba(158,127,255,0.4)' }}>
        ...
        <div className="lg:col-span-2 card-gastro">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={[...REVENUE_DATA, { day: 'Lun+', revenue: 720000, orders: 280, target: 650000 }, { day: 'Mar+', revenue: 680000, orders: 265, target: 620000 }]}
              ...
              <Area type="monotone" dataKey="revenue" stroke="#9E7FFF" strokeWidth={2.5} fill="url(#revGrad2)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="card-gastro">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <RadarChart data={RADAR_DATA}>
              ...
              <Radar name="Score" dataKey="A" stroke="#9E7FFF" fill="#9E7FFF" fillOpacity={0.2} strokeWidth={2} />
            </RadarChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="card-gastro">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: '🐄 Vacas', desc: 'Alta rotación + margen medio', products: ['Pizza Margherita', 'Lomo a la Pimienta'], color: '#38bdf8' },
