...
import {
  ...
  CheckCircle, AlertCircle, Coffee, ChevronRight, Zap, Bell, ScanEye
} from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <button type="button" onClick={() => navigate('/eye')}
        className="w-full rounded-2xl p-4 flex items-center gap-4 text-left transition-all hover:scale-[1.005]"
        style={{
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gastro-subtle">
            Visión IA detectando vasos vacíos, manos levantadas y mesas sin atención — Configuración y monitoreo en vivo
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Pedidos activos', value: LIVE_ORDERS.filter(o => o.status !== 'delivered').length, color: '#3B82F6', icon: UtensilsCrossed },
        ].map(stat => {
