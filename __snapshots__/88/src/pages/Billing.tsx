      ...
      <div className="grid md:grid-cols-3 gap-6">
        {PLANS.map(plan => (
          <div key={plan.name}
            ...
            style={{
              background: plan.current ? 'linear-gradient(135deg, rgba(37,99,235,0.12) 0%, rgba(59,130,246,0.06) 100%)' : '#0F1628',
              border: `1px solid ${plan.current ? 'rgba(37,99,235,0.4)' : '#1A2540'}`,
              boxShadow: plan.current ? '0 0 40px rgba(37,99,235,0.15)' : 'none',
            }}>
            {plan.current && (
